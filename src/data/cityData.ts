...
import nweNkrumahQuote from "@/assets/nwe-nkrumah-quote.jpg";
import nweMarketLady from "@/assets/nwe-market-lady.jpg";
...
export const cities: City[] = [
  ...
  { id: "ottawa", name: "Ottawa, Canada", flag: "🇨🇦" },
  ...
  { id: "melbourne", name: "Melbourne, Australia", flag: "🇦🇺" },
  { id: "brisbane", name: "Brisbane, Australia", flag: "🇦🇺" },
  { id: "perth", name: "Perth, Australia", flag: "🇦🇺" },
  { id: "adelaide", name: "Adelaide, Australia", flag: "🇦🇺" },
  // Brazil
  ...
  { id: "portofspain", name: "Port of Spain, Trinidad & Tobago", flag: "🇹🇹" },
  { id: "georgetown", name: "Georgetown, Guyana", flag: "🇬🇾" },
  { id: "bridgetownbb", name: "Bridgetown, Barbados", flag: "🇧🇧" },
  { id: "panama", name: "Panama City, Panama", flag: "🇵🇦" },
  { id: "cartagena", name: "Cartagena, Colombia", flag: "🇨🇴" },
  { id: "cali", name: "Cali, Colombia", flag: "🇨🇴" },
  { id: "quito", name: "Quito, Ecuador", flag: "🇪🇨" },
  { id: "limon", name: "Limón, Costa Rica", flag: "🇨🇷" },
  { id: "belize", name: "Belize City, Belize", flag: "🇧🇿" },
  { id: "managua", name: "Managua, Nicaragua", flag: "🇳🇮" },
  { id: "tegucigalpa", name: "Tegucigalpa, Honduras", flag: "🇭🇳" },
  // Africa
  ...
  { id: "daressalaam", name: "Dar es Salaam, Tanzania", flag: "🇹🇿" },
  ...
  { id: "luxor", name: "Luxor, Egypt", flag: "🇪🇬" },
  ...
  { id: "brazzaville", name: "Brazzaville, Republic of Congo", flag: "🇨🇬" },
  { id: "djibouti", name: "Djibouti City, Djibouti", flag: "🇩🇯" },
...
export const events: EventItem[] = [
  // Austin — SXSW 2026 (real events, Mar 12–18)
  { id: SXSW_EVENT_ID, title: "I Love Boosters — Opening Night Film (Keke Palmer, LaKeith Stanfield)", host: "SXSW Film & TV", date: "Wed, Mar 12 · 7:00 PM", venue: "Paramount Theatre", city: "austin", distance: "0.8 mi", image: eventConcert, attending: 2400, free: false, price: "Badge Required", category: "Film", source: "sxsw", external_url: "https://schedule.sxsw.com/2026/events/FS19252" },
  { id: 7778, title: "Ty Dolla $ign — SXSW Music Showcase", host: "SXSW Music Festival", date: "Sat, Mar 14 · 11:00 PM", venue: "Stubb's BBQ", city: "austin", distance: "1.2 mi", image: eventRapConcert, attending: 5200, free: false, price: "Badge/Wristband", category: "Concert", source: "sxsw", external_url: "https://sxsw.com/festivals/music-festival/" },
  { id: 7779, title: "Jack Johnson & Hermanos Gutiérrez — SXSW Music", host: "SXSW Music Festival", date: "Fri, Mar 13 · 9:00 PM", venue: "ACL Live at The Moody Theater", city: "austin", distance: "0.7 mi", image: eventConcert, attending: 4800, free: false, price: "Badge/Wristband", category: "Concert", source: "sxsw", external_url: "https://sxsw.com/festivals/music-festival/" },
  { id: 7780, title: "Vic Mensa — SXSW Music Showcase", host: "SXSW Music Festival", date: "Thu, Mar 13 · 10:00 PM", venue: "Empire Control Room", city: "austin", distance: "1.8 mi", image: eventRapConcert, attending: 1800, free: false, price: "Badge/Wristband", category: "Concert", source: "sxsw", external_url: "https://sxsw.com/festivals/music-festival/" },
  { id: 7781, title: "A Conversation with Serena Williams — Keynote", host: "SXSW Conference", date: "Thu, Mar 13 · 1:00 PM", venue: "Austin Convention Center", city: "austin", distance: "0.5 mi", image: eventAfricanArt, attending: 3500, free: false, price: "Badge Required", category: "Networking", source: "sxsw", external_url: "https://sxsw.com/keynotes/" },
  { id: 7782, title: "Alanis Morissette — SXSW Music Showcase", host: "SXSW Music Festival", date: "Sun, Mar 16 · 8:00 PM", venue: "Stubb's BBQ", city: "austin", distance: "1.2 mi", image: eventConcert, attending: 6000, free: false, price: "Badge/Wristband", category: "Concert", source: "sxsw", external_url: "https://sxsw.com/festivals/music-festival/" },
  { id: 7783, title: "A Conversation with Jane Fonda — Keynote", host: "SXSW Conference", date: "Fri, Mar 14 · 1:00 PM", venue: "Austin Convention Center", city: "austin", distance: "0.5 mi", image: eventAfricanArt, attending: 4200, free: false, price: "Badge Required", category: "Networking", source: "sxsw", external_url: "https://sxsw.com/keynotes/" },
  { id: 7784, title: "EMJAY — SXSW Music Showcase", host: "SXSW Music Festival", date: "Sat, Mar 15 · 10:00 PM", venue: "Mohawk", city: "austin", distance: "1.0 mi", image: eventUkAfrobeats, attending: 1500, free: false, price: "Badge/Wristband", category: "Concert", source: "sxsw", external_url: "https://sxsw.com/festivals/music-festival/" },
  { id: 7785, title: "A Conversation with Demi Moore — Keynote", host: "SXSW Conference", date: "Wed, Mar 12 · 1:00 PM", venue: "Austin Convention Center", city: "austin", distance: "0.5 mi", image: eventAfricanArt, attending: 3800, free: false, price: "Badge Required", category: "Networking", source: "sxsw", external_url: "https://sxsw.com/keynotes/" },
  { id: 7786, title: "All The Vibes — Official Afrobeats Showcase", host: "All The Vibes x SXSW", date: "Fri, Mar 14 · 9:00 PM", venue: "Flamingo Cantina", city: "austin", distance: "1.4 mi", image: eventParty, attending: 1200, free: false, price: "$25", category: "Afrobeats", source: "sxsw", external_url: "https://www.eventbrite.com/e/all-the-vibes-x-sxsw-2025-official-afrobeats-showcase-tickets-1276546548089" },
  ...
  // Rio de Janeiro
  { id: 698, title: "AFRO LOVE — The Party 🖤✨", host: "Afro Love Brasil", date: "Sat, Mar 1 · 11:00 PM", venue: "Casa da Matriz, Botafogo", city: "rio", distance: "1.5 km", image: eventParty, attending: 3000, free: false, price: "R$80", category: "Party" },
  { id: 699, title: "Carnaval 2026 — Sambódromo", host: "LIESA", date: "Fri, Feb 27 – Tue, Mar 3", venue: "Sambódromo Marquês de Sapucaí", city: "rio", distance: "3.0 km", image: eventUkAfrobeats, attending: 72000, free: false, price: "R$150–R$2000", category: "Festival" },
  ...
  { id: 705, title: "Bloco Ilê Aiyê — Rio", host: "Ilê Aiyê", date: "Sun, Mar 1 · 3:00 PM", venue: "Praça XV", city: "rio", distance: "2.0 km", image: eventConcert, attending: 5000, free: true, category: "Festival" },
  ...
  { id: 715, title: "Carnaval SP — Vai-Vai Bloco", host: "Vai-Vai Samba School", date: "Sat, Feb 28 · 4:00 PM", venue: "Anhangabaú Valley", city: "saopaulo", distance: "1.0 km", image: eventConcert, attending: 20000, free: true, category: "Festival" },
  ...
  { id: 725, title: "Carnaval Salvador — Circuito Barra-Ondina", host: "Prefeitura de Salvador", date: "Fri, Feb 27 – Tue, Mar 3", venue: "Barra-Ondina Circuit", city: "salvador", distance: "2.5 km", image: eventUkAfrobeats, attending: 200000, free: true, category: "Festival" },
  { id: 726, title: "Ivete Sangalo — Carnaval Show", host: "Ivete Sangalo", date: "Sat, Feb 28 · 9:00 PM", venue: "Campo Grande Circuit", city: "salvador", distance: "1.0 km", image: eventRapConcert, attending: 50000, free: false, price: "R$200", category: "Festival" },
  ...
  // ========== AFRO NATION 2026 — PORTIMÃO, PORTUGAL ==========
  // Main Festival — Jul 3–5, 2026
  // Real lineup: Burna Boy, Wizkid, Asake, Tyla, Ayra Starr, Rema, Omah Lay, Shallipopi, Bnxn
  {
    id: AFRO_NATION_EVENT_ID, title: "AFRO NATION PORTUGAL 2026 — Burna Boy · Wizkid · Asake · Tyla", host: "Afro Nation",
    date: "Jul 3–5 · All Day", venue: "Praia da Rocha, Portimão", city: "portimao",
    distance: "", image: eventAfroNationLogo, attending: 45000, free: false,
    price: "$415+", category: "Festival", source: "posh", external_url: "https://www.afronation.com/book-tickets"
  },

  // Day-by-day headliners (real 2026 lineup from JamBase)
  { id: 1500, title: "Burna Boy & Tyla — Afro Nation Day 1", host: "Afro Nation", date: "Fri, Jul 3 · 4:00 PM", venue: "Praia da Rocha Main Stage", city: "portimao", distance: "0 km", image: eventAfroNationLogo, attending: 45000, free: false, price: "$415+", category: "Afrobeats", source: "posh", external_url: "https://www.afronation.com/book-tickets" },
  { id: 1501, title: "Wizkid & Ayra Starr — Afro Nation Day 2", host: "Afro Nation", date: "Sat, Jul 4 · 4:00 PM", venue: "Praia da Rocha Main Stage", city: "portimao", distance: "0 km", image: eventAfroNationLogo, attending: 45000, free: false, price: "$415+", category: "Afrobeats", source: "posh", external_url: "https://www.afronation.com/book-tickets" },
  { id: 1502, title: "Asake & Rema — Afro Nation Day 3", host: "Afro Nation", date: "Sun, Jul 5 · 4:00 PM", venue: "Praia da Rocha Main Stage", city: "portimao", distance: "0 km", image: eventAfroNationLogo, attending: 45000, free: false, price: "$415+", category: "Afrobeats", source: "posh", external_url: "https://www.afronation.com/book-tickets" },

  // After Parties & Side Events
  { id: 1503, title: "Afro Nation Official Pre-Party 2026", host: "Afro Nation", date: "Wed, Jul 2 · 10:00 PM", venue: "NoSoloÁgua Portimão", city: "portimao", distance: "0.5 km", image: eventParty, attending: 2500, free: false, price: "€25", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1504, title: "Amapiano Pool Party — Algarve", host: "Vibes Algarve", date: "Thu, Jul 3 · 2:00 PM", venue: "Algarve Casino Rooftop", city: "portimao", distance: "1.0 km", image: eventParty, attending: 800, free: false, price: "€30", category: "Party" },
  { id: 1505, title: "Omah Lay Late Night Set", host: "Afro Nation", date: "Fri, Jul 3 · 12:00 AM", venue: "Katedral Club Portimão", city: "portimao", distance: "1.2 km", image: eventConcert, attending: 2500, free: false, price: "€45", category: "Afrobeats" },
  { id: 1506, title: "Burna Boy Official After Party", host: "Spaceship Ent.", date: "Fri, Jul 3 · 11:30 PM", venue: "NoSoloÁgua Portimão", city: "portimao", distance: "0.5 km", image: eventRapConcert, attending: 3500, free: false, price: "€50", category: "Afrobeats" },
  { id: 1507, title: "Afro Nation Day Party — Poolside", host: "Afro Nation x Hennessy", date: "Sat, Jul 4 · 1:00 PM", venue: "Jupiter Algarve Hotel Pool", city: "portimao", distance: "0.8 km", image: eventParty, attending: 1500, free: false, price: "€35", category: "Party" },
  { id: 1508, title: "Wizkid Late Night Set", host: "Starboy Ent.", date: "Sat, Jul 4 · 12:00 AM", venue: "Katedral Club Portimão", city: "portimao", distance: "1.2 km", image: eventConcert, attending: 2500, free: false, price: "€45", category: "Afrobeats" },
  { id: 1509, title: "Closing Party — Afro Nation 2026", host: "Afro Nation", date: "Sun, Jul 5 · 11:00 PM", venue: "Praia da Rocha Open Air", city: "portimao", distance: "0.2 km", image: eventAfroNationLogo, attending: 5000, free: false, price: "€35", category: "Party", source: "posh", external_url: "https://afronation.com" },

  // Ticket tiers (from afronation.com/book-tickets)
  // General Admission Advance 1: $415.21 | Advance 2: $474.69 | Final Release: $593.66
  // Golden Ticket Advance 3: $950.57 | Final Release: $1,069.54
  // VIP Final Release: $712.63 (SOLD OUT)

  // Food & Culture in Portimão
  { id: 1520, title: "Afro Food Festival Portimão 2026", host: "Diaspora Eats EU", date: "Jul 3–5 · 11:00 AM", venue: "Largo 1º de Dezembro", city: "portimao", distance: "0.6 km", image: eventBrunch, attending: 4000, free: true, category: "Food" },
  { id: 1521, title: "Jollof Wars — Portugal Edition", host: "Jollof Wars", date: "Fri, Jul 3 · 12:00 PM", venue: "Mercado Municipal de Portimão", city: "portimao", distance: "0.4 km", image: eventBrunch, attending: 1000, free: false, price: "€10", category: "Food" },
  { id: 1522, title: "Suya & Beats Pop-Up", host: "Lagos Grill Co.", date: "Sat, Jul 4 · 12:00 PM", venue: "Marina de Portimão", city: "portimao", distance: "0.7 km", image: eventBrunch, attending: 800, free: true, category: "Food" },
  { id: 1523, title: "Afro-Portuguese Wine & Dine", host: "Algarve Culture Club", date: "Wed, Jul 2 · 7:00 PM", venue: "Restaurante Forte & Feio", city: "portimao", distance: "0.3 km", image: eventBrunch, attending: 120, free: false, price: "€55", category: "Food" },
  { id: 1524, title: "African Art Market — Algarve", host: "Diaspora Arts Collective", date: "Jul 3–5 · 10:00 AM", venue: "Museu de Portimão", city: "portimao", distance: "0.5 km", image: eventAfricanArt, attending: 1500, free: true, category: "Culture" },
  { id: 1525, title: "Diaspora Networking Mixer", host: "AfroTech EU", date: "Thu, Jul 3 · 6:00 PM", venue: "Hotel & Spa Jupiter", city: "portimao", distance: "0.8 km", image: networkingConference, attending: 250, free: false, price: "€20", category: "Networking" },

  // ========== AFRO NATION SATELLITE EVENTS 2026 ==========

  // San Juan, Puerto Rico
  { id: 1600, title: "AFRO NATION SAN JUAN 2026", host: "Afro Nation", date: "Aug 14–16 · All Day", venue: "Escambrón Beach, San Juan", city: "sanjuan", distance: "", image: eventAfroNationLogo, attending: 20000, free: false, price: "$89+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1601, title: "Afro Nation Pre-Party — Old San Juan", host: "Afro Nation x Bacardí", date: "Thu, Aug 13 · 10:00 PM", venue: "La Placita de Santurce", city: "sanjuan", distance: "1.5 mi", image: eventParty, attending: 2500, free: false, price: "$30", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1602, title: "Reggaetón x Afrobeats Clash", host: "Island Vibes PR", date: "Fri, Aug 14 · 11:00 PM", venue: "Club Brava, Condado", city: "sanjuan", distance: "0.8 mi", image: eventParty, attending: 1500, free: false, price: "$40", category: "Party" },
  { id: 1603, title: "Amapiano Beach Session — PR", host: "Vibes Caribe", date: "Sat, Aug 15 · 2:00 PM", venue: "Ocean Park Beach", city: "sanjuan", distance: "1.2 mi", image: eventParty, attending: 800, free: false, price: "$25", category: "Party" },
  { id: 1604, title: "Jollof vs Mofongo Cook-Off", host: "Diaspora Eats PR", date: "Sat, Aug 15 · 12:00 PM", venue: "Mercado Santurce", city: "sanjuan", distance: "1.0 mi", image: eventBrunch, attending: 600, free: false, price: "$15", category: "Food" },
  { id: 1605, title: "Afro Nation Closing Party PR", host: "Afro Nation", date: "Sun, Aug 16 · 10:00 PM", venue: "La Concha Resort Pool", city: "sanjuan", distance: "0.5 mi", image: eventAfroNationLogo, attending: 3000, free: false, price: "$45", category: "Party", source: "posh", external_url: "https://afronation.com" },

  // Detroit, Michigan
  { id: 1620, title: "AFRO NATION DETROIT 2026", host: "Afro Nation", date: "Jul 24–26 · All Day", venue: "Hart Plaza, Detroit", city: "detroit", distance: "", image: eventAfroNationLogo, attending: 25000, free: false, price: "$79+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1621, title: "Motown x Afrobeats Fusion Night", host: "Afro Nation x Motown", date: "Thu, Jul 23 · 9:00 PM", venue: "The Majestic Detroit", city: "detroit", distance: "0.5 mi", image: eventRapConcert, attending: 2000, free: false, price: "$35", category: "Afrobeats", source: "posh" },
  { id: 1622, title: "Afro Nation Day Party — Riverside", host: "Afro Nation US", date: "Sat, Jul 25 · 1:00 PM", venue: "Riverside Marina", city: "detroit", distance: "1.0 mi", image: eventParty, attending: 3000, free: false, price: "$30", category: "Party" },
  { id: 1623, title: "Techno x Amapiano After Dark", host: "Detroit Sound Collective", date: "Sat, Jul 25 · 11:00 PM", venue: "TV Lounge", city: "detroit", distance: "1.5 mi", image: eventParty, attending: 1200, free: false, price: "$25", category: "Party" },
  { id: 1624, title: "African Food & Culture Fest Detroit", host: "Diaspora Detroit", date: "Sun, Jul 26 · 11:00 AM", venue: "Eastern Market", city: "detroit", distance: "1.2 mi", image: eventBrunch, attending: 2500, free: true, category: "Food" },

  // Miami, Florida
  { id: 1630, title: "AFRO NATION MIAMI 2026", host: "Afro Nation", date: "May 22–24 · All Day", venue: "Bayfront Park, Miami", city: "miami", distance: "", image: eventAfroNationLogo, attending: 35000, free: false, price: "$99+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1631, title: "Afro Nation Pre-Party — Wynwood", host: "Afro Nation x Hennessy", date: "Thu, May 21 · 10:00 PM", venue: "Wynwood Factory", city: "miami", distance: "2.5 mi", image: eventParty, attending: 3000, free: false, price: "$40", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1632, title: "Soca x Afrobeats Pool Party", host: "Caribbean Vibes MIA", date: "Fri, May 22 · 1:00 PM", venue: "SLS South Beach Pool", city: "miami", distance: "1.0 mi", image: eventParty, attending: 1500, free: false, price: "$50", category: "Party" },
  { id: 1633, title: "Burna Boy After Party Miami", host: "Spaceship Ent.", date: "Fri, May 22 · 11:30 PM", venue: "LIV Miami", city: "miami", distance: "1.0 mi", image: eventRapConcert, attending: 4000, free: false, price: "$60", category: "Afrobeats", source: "posh" },
  { id: 1634, title: "Little Haiti x Afro Nation Block Party", host: "Little Haiti Cultural", date: "Sat, May 23 · 12:00 PM", venue: "Little Haiti Cultural Complex", city: "miami", distance: "3.0 mi", image: eventAfricanArt, attending: 2000, free: true, category: "Culture" },
  { id: 1635, title: "Afro Nation Closing Party MIA", host: "Afro Nation", date: "Sun, May 24 · 10:00 PM", venue: "E11EVEN Miami", city: "miami", distance: "0.5 mi", image: eventAfroNationLogo, attending: 3500, free: false, price: "$55", category: "Party", source: "posh", external_url: "https://afronation.com" },

  // Accra, Ghana — Detty December
  { id: 1640, title: "AFRO NATION GHANA 2026", host: "Afro Nation", date: "Dec 27–29 · All Day", venue: "Marine Drive, Accra", city: "accra", distance: "", image: eventAfroNationLogo, attending: 30000, free: false, price: "GH₵200+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1641, title: "Detty December Kick-Off Party", host: "Afro Nation x Afrochella", date: "Fri, Dec 26 · 10:00 PM", venue: "Republic Bar & Grill, Osu", city: "accra", distance: "2.0 km", image: eventParty, attending: 3000, free: false, price: "GH₵100", category: "Party", source: "posh" },
  { id: 1642, title: "Amapiano on the Beach — Accra", host: "Vibes Ghana", date: "Sat, Dec 27 · 2:00 PM", venue: "Labadi Beach Hotel", city: "accra", distance: "5.0 km", image: eventParty, attending: 2000, free: false, price: "GH₵80", category: "Party" },
  { id: 1643, title: "Jollof Wars — Ghana vs Nigeria", host: "Jollof Wars", date: "Sun, Dec 28 · 12:00 PM", venue: "Accra Mall Open Court", city: "accra", distance: "4.0 km", image: eventBrunch, attending: 1500, free: false, price: "GH₵50", category: "Food" },
  { id: 1644, title: "Afro Nation Ghana Closing Party", host: "Afro Nation", date: "Mon, Dec 29 · 10:00 PM", venue: "Sandbox Beach Club", city: "accra", distance: "1.5 km", image: eventAfroNationLogo, attending: 5000, free: false, price: "GH₵150", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1645, title: "Pan-African Art Exhibition", host: "Nubuke Foundation", date: "Dec 26–30 · 10:00 AM", venue: "Nubuke Foundation, East Legon", city: "accra", distance: "6.0 km", image: eventAfricanArt, attending: 800, free: true, category: "Culture" },

  // Lagos, Nigeria — Detty December
  { id: 1650, title: "AFRO NATION LAGOS 2026", host: "Afro Nation", date: "Dec 19–21 · All Day", venue: "Eko Atlantic City, Lagos", city: "lagos", distance: "", image: eventAfroNationLogo, attending: 40000, free: false, price: "₦25,000+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1651, title: "Detty December — Lagos Pre-Party", host: "Afro Nation x Flytime", date: "Thu, Dec 18 · 10:00 PM", venue: "Landmark Beach, Victoria Island", city: "lagos", distance: "3.0 km", image: eventParty, attending: 5000, free: false, price: "₦15,000", category: "Party", source: "posh" },
  { id: 1652, title: "Wizkid Homecoming Show", host: "Starboy Ent.", date: "Fri, Dec 19 · 9:00 PM", venue: "Eko Convention Centre", city: "lagos", distance: "2.0 km", image: eventConcert, attending: 8000, free: false, price: "₦30,000", category: "Afrobeats", source: "posh" },
  { id: 1653, title: "Amapiano x Afrobeats Rooftop", host: "Lagos Social Club", date: "Sat, Dec 20 · 3:00 PM", venue: "Sky Lounge, Victoria Island", city: "lagos", distance: "1.5 km", image: eventParty, attending: 1500, free: false, price: "₦10,000", category: "Party" },
  { id: 1654, title: "Suya & Beats Block Party", host: "Lagos Grill Co.", date: "Sat, Dec 20 · 12:00 PM", venue: "Lekki Phase 1", city: "lagos", distance: "4.0 km", image: eventBrunch, attending: 2000, free: true, category: "Food" },
  { id: 1655, title: "Afro Nation Lagos Closing Party", host: "Afro Nation", date: "Sun, Dec 21 · 10:00 PM", venue: "Quilox Nightclub, VI", city: "lagos", distance: "2.5 km", image: eventAfroNationLogo, attending: 4000, free: false, price: "₦20,000", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1656, title: "Nigerian Art & Fashion Pop-Up", host: "Lagos Fashion Week", date: "Dec 19–21 · 11:00 AM", venue: "Nike Art Gallery, Lekki", city: "lagos", distance: "5.0 km", image: eventAfricanArt, attending: 1200, free: true, category: "Culture" },
];
