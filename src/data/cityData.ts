...
export const events: EventItem[] = [
  ...
  // ========== AFRO NATION SATELLITE EVENTS ==========

  // San Juan, Puerto Rico
  { id: 1600, title: "AFRO NATION SAN JUAN 2025", host: "Afro Nation", date: "Aug 15–17 · All Day", venue: "Escambrón Beach, San Juan", city: "sanjuan", distance: "", image: eventAfroNationLogo, attending: 20000, free: false, price: "$89+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1601, title: "Afro Nation Pre-Party — Old San Juan", host: "Afro Nation x Bacardí", date: "Thu, Aug 14 · 10:00 PM", venue: "La Placita de Santurce", city: "sanjuan", distance: "1.5 mi", image: eventParty, attending: 2500, free: false, price: "$30", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1602, title: "Reggaetón x Afrobeats Clash", host: "Island Vibes PR", date: "Fri, Aug 15 · 11:00 PM", venue: "Club Brava, Condado", city: "sanjuan", distance: "0.8 mi", image: eventParty, attending: 1500, free: false, price: "$40", category: "Party" },
  { id: 1603, title: "Amapiano Beach Session — PR", host: "Vibes Caribe", date: "Sat, Aug 16 · 2:00 PM", venue: "Ocean Park Beach", city: "sanjuan", distance: "1.2 mi", image: eventParty, attending: 800, free: false, price: "$25", category: "Party" },
  { id: 1604, title: "Jollof vs Mofongo Cook-Off", host: "Diaspora Eats PR", date: "Sat, Aug 16 · 12:00 PM", venue: "Mercado Santurce", city: "sanjuan", distance: "1.0 mi", image: eventBrunch, attending: 600, free: false, price: "$15", category: "Food" },
  { id: 1605, title: "Afro Nation Closing Party PR", host: "Afro Nation", date: "Sun, Aug 17 · 10:00 PM", venue: "La Concha Resort Pool", city: "sanjuan", distance: "0.5 mi", image: eventAfroNationLogo, attending: 3000, free: false, price: "$45", category: "Party", source: "posh", external_url: "https://afronation.com" },

  // Santo Domingo, Dominican Republic
  { id: 1610, title: "AFRO NATION SANTO DOMINGO 2025", host: "Afro Nation", date: "Sep 5–7 · All Day", venue: "Playa Boca Chica, Santo Domingo", city: "santodomingo", distance: "", image: eventAfroNationLogo, attending: 18000, free: false, price: "$75+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1611, title: "Dembow x Afrobeats Night", host: "RD Vibes", date: "Thu, Sep 4 · 10:00 PM", venue: "Zona Colonial", city: "santodomingo", distance: "2.0 km", image: eventParty, attending: 1500, free: false, price: "$25", category: "Party" },
  { id: 1612, title: "Afro-Caribbean Day Party", host: "Afro Nation DR", date: "Sat, Sep 6 · 1:00 PM", venue: "Playa Juan Dolio", city: "santodomingo", distance: "5.0 km", image: eventParty, attending: 2000, free: false, price: "$35", category: "Party", source: "posh" },
  { id: 1613, title: "Merengue meets Afrobeats Brunch", host: "Diaspora Eats DR", date: "Sun, Sep 7 · 11:00 AM", venue: "Hotel El Embajador", city: "santodomingo", distance: "3.0 km", image: eventBrunch, attending: 400, free: false, price: "$40", category: "Food" },

  // Detroit, Michigan
  { id: 1620, title: "AFRO NATION DETROIT 2025", host: "Afro Nation", date: "Jul 25–27 · All Day", venue: "Hart Plaza, Detroit", city: "detroit", distance: "", image: eventAfroNationLogo, attending: 25000, free: false, price: "$79+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1621, title: "Motown x Afrobeats Fusion Night", host: "Afro Nation x Motown", date: "Thu, Jul 24 · 9:00 PM", venue: "The Majestic Detroit", city: "detroit", distance: "0.5 mi", image: eventRapConcert, attending: 2000, free: false, price: "$35", category: "Afrobeats", source: "posh" },
  { id: 1622, title: "Afro Nation Day Party — Riverside", host: "Afro Nation US", date: "Sat, Jul 26 · 1:00 PM", venue: "Riverside Marina", city: "detroit", distance: "1.0 mi", image: eventParty, attending: 3000, free: false, price: "$30", category: "Party" },
  { id: 1623, title: "Techno x Amapiano After Dark", host: "Detroit Sound Collective", date: "Sat, Jul 26 · 11:00 PM", venue: "TV Lounge", city: "detroit", distance: "1.5 mi", image: eventParty, attending: 1200, free: false, price: "$25", category: "Party" },
  { id: 1624, title: "African Food & Culture Fest Detroit", host: "Diaspora Detroit", date: "Sun, Jul 27 · 11:00 AM", venue: "Eastern Market", city: "detroit", distance: "1.2 mi", image: eventBrunch, attending: 2500, free: true, category: "Food" },

  // Miami, Florida
  { id: 1630, title: "AFRO NATION MIAMI 2025", host: "Afro Nation", date: "May 23–25 · All Day", venue: "Bayfront Park, Miami", city: "miami", distance: "", image: eventAfroNationLogo, attending: 35000, free: false, price: "$99+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  { id: 1631, title: "Afro Nation Pre-Party — Wynwood", host: "Afro Nation x Hennessy", date: "Thu, May 22 · 10:00 PM", venue: "Wynwood Factory", city: "miami", distance: "2.5 mi", image: eventParty, attending: 3000, free: false, price: "$40", category: "Party", source: "posh", external_url: "https://afronation.com" },
  { id: 1632, title: "Soca x Afrobeats Pool Party", host: "Caribbean Vibes MIA", date: "Fri, May 23 · 1:00 PM", venue: "SLS South Beach Pool", city: "miami", distance: "1.0 mi", image: eventParty, attending: 1500, free: false, price: "$50", category: "Party" },
  { id: 1633, title: "Burna Boy After Party Miami", host: "Spaceship Ent.", date: "Fri, May 23 · 11:30 PM", venue: "LIV Miami", city: "miami", distance: "1.0 mi", image: eventRapConcert, attending: 4000, free: false, price: "$60", category: "Afrobeats", source: "posh" },
  { id: 1634, title: "Little Haiti x Afro Nation Block Party", host: "Little Haiti Cultural", date: "Sat, May 24 · 12:00 PM", venue: "Little Haiti Cultural Complex", city: "miami", distance: "3.0 mi", image: eventAfricanArt, attending: 2000, free: true, category: "Culture" },
  { id: 1635, title: "Afro Nation Closing Party MIA", host: "Afro Nation", date: "Sun, May 25 · 10:00 PM", venue: "E11EVEN Miami", city: "miami", distance: "0.5 mi", image: eventAfroNationLogo, attending: 3500, free: false, price: "$55", category: "Party", source: "posh", external_url: "https://afronation.com" },

  // Accra, Ghana
  { id: 1640, title: "AFRO NATION GHANA 2025", host: "Afro Nation", date: "Dec 27–29 · All Day", venue: "Marine Drive, Accra", city: "accra", distance: "", image: eventAfroNationLogo, attending: 30000, free: false, price: "GH₵200+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
  ...
  // Lagos, Nigeria
  { id: 1650, title: "AFRO NATION LAGOS 2025", host: "Afro Nation", date: "Dec 19–21 · All Day", venue: "Eko Atlantic City, Lagos", city: "lagos", distance: "", image: eventAfroNationLogo, attending: 40000, free: false, price: "₦25,000+", category: "Festival", source: "posh", external_url: "https://afronation.com" },
