import { Newspaper, Film, MapPinned, Heart, CalendarDays, MessageCircle, User, BookOpen, GraduationCap } from "lucide-react";

type Tab = "feed" | "reels" | "map" | "match" | "events" | "messages" | "culture" | "campus" | "profile";
