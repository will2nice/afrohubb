import { Newspaper, Film, MapPinned, Heart, CalendarDays, MessageCircle, User, BookOpen } from "lucide-react";

type Tab = "feed" | "reels" | "map" | "match" | "events" | "messages" | "culture" | "profile";
